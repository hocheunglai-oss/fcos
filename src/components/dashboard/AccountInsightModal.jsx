          ...
          <div className="flex flex-col gap-4 xl:flex-row xl:items-center xl:justify-between">
            <div className="min-w-0">
              <div className="mb-1 flex flex-wrap items-center gap-2">
                ...
                {identity.inactive ? <span className="rounded-sm bg-amber-100 px-2 py-0.5 text-[11px] font-semibold text-amber-900">Inactive history</span> : null}
                  ...
                  <div className="grid gap-5 lg:grid-cols-2">
                    <Section title="Relationship" description="Salesforce identity and FCOS ownership context">
                      <dl className="grid grid-cols-2 gap-x-5 gap-y-3 text-sm">
                        ...
                        <div><dt className="text-xs text-muted-foreground">Account state</dt><dd className="font-medium">{identity.inactive ? 'Inactive' : 'Active'}</dd></div>
