...
export default function AccountCreditStatement({ accountId, active, statementSide = 'buyer', availableStatementSides = ['buyer'], onStatementSideChange, onStemClick }) {
