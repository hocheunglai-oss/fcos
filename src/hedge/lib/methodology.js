...
export const PAGE_METHODOLOGIES = {
  ...
  Hedges: {
    ...
    steps: [
      ...
      "Expiry is server-controlled: each contract month must reach its final Platts trading day, contain every scheduled actual MOPS value, and have its one final monthly average verified against a pasted third-party message.",
  ...
  "MOPS market": {
    ...
    steps: [
      ...
      "After all daily values are complete, one manually pasted third-party message must match the final S380, S0.5, and SGO monthly averages.",
      "A paper hedge expires automatically after every contract month reaches its final trading day and its completed monthly average is source-verified.",
