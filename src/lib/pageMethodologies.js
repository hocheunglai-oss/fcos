  ...
  system: {
    ...
    sections: [
      ...
      },
      {
        ...
        body: 'Email templates, recipients, schedules, and sender displays remain subject to the authenticated sender and external-action safety gates. Saving a setting does not send an email.',
      },
      {
      ...
      {
        title: 'System health',
        body: 'Health states combine direct probes and provider telemetry. Monitoring unavailable is distinct from Online; a missing metric is never presented as a healthy result.',
      },
    ],
  },
  users: {
