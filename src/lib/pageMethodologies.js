...
export const EMAIL_ROUTER_METHODOLOGY = {
  ...
  sections: [
    ...
    { title: 'Recipients and actions', body: 'Redirect numbers To, Cc, and Bcc independently and preserves visible To/Cc order; Bcc stays private and hidden until used. Redirect has one explicit Send command and processes only that action in the foreground. The blue action toolbar is separate from mailbox navigation. Archive and Market Report move a message immediately with one click; Delete, Undo, and uncertain-send review retain their confirmation safeguards.' },
