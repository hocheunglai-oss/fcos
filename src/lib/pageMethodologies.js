...
export const EMAIL_ROUTER_METHODOLOGY = {
  ...
  sections: [
    ...
    { title: 'Route Message', body: 'The fixed Route Message panel handles Forward and Redirect with ordered To, Cc, and Bcc recipients. Forward may include an introduction; Redirect preserves the original MIME and reply path. Presets remain editable after selection, and any manual recipient amendment clears the preset label.' },
