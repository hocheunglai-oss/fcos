...
export const DASHBOARD_METHODOLOGY = {
  ...
  sections: [
    ...
    },
    {
      ...
      body: 'Overview totals are shown only when FCOS has processed the complete matching scope. An incomplete Salesforce response suppresses financial totals and asks you to narrow the filters; an incomplete previous-year scope independently suppresses YoY lines. The STEMs tab is server-paginated and sorted. Accounts combines buyer Credit Statements and complete period buyer/supplier rankings in one searchable table, while Overview keeps its concise Top-10 chart. Account Insight has a linkable Account route, loads only the selected tab, inherits the exact Dashboard period, Port, COUNTRY, and dispute scope, and offers an explicit Account-wide toggle. Rankings exclude the Fratelli Cosulich GROUP identity and every descendant Account resolved through the live Salesforce hierarchy.',
    },
    {
