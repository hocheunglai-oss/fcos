...
export const SPECIAL_TERMS_DOCUMENT_TOKENS = Object.freeze({
  ...
  typography: Object.freeze({ family: 'Arial', bodyPt: 12, lineMultiplier: 1.25, clauseAfterPt: 7, bodyAlignment: 'justify', lastLineAlignment: 'left', headingAlignment: 'center', sectionLabelPt: 9, titlePt: 15, companyPt: 10, detailsPt: 6.5 }),
