...
export const SPECIAL_TERMS_DOCUMENT_TOKENS = Object.freeze({
  ...
  typography: Object.freeze({ family: 'IBM Plex Sans', browserFamily: '"IBM Plex Sans Variable", "IBM Plex Sans", sans-serif', headingWeight: 600, bodyPt: 11, lineMultiplier: 15 / 11, clauseAfterPt: 7, bodyAlignment: 'left', lastLineAlignment: 'left', headingAlignment: 'center', sectionLabelPt: 9, titlePt: 15, companyPt: 10, detailsPt: 6.5 }),
